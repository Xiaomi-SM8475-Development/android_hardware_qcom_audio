...
-include $(TOPDIR)hardware/qcom-caf/sm8450/audio/configs/common/default.mk
else
# Audio hal configuration file
-include $(TOPDIR)hardware/qcom-caf/sm8450/audio/configs/$(TARGET_BOARD_PLATFORM)/$(TARGET_BOARD_PLATFORM).mk
endif
else
# Audio hal configuration file
-include $(TOPDIR)hardware/qcom-caf/sm8450/audio/configs/$(TARGET_BOARD_PLATFORM)/$(TARGET_BOARD_PLATFORM).mk
